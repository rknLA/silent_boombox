//
//  WCAddListenersViewController.m
//  SilentBoombox
//
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [[listeners objectAtIndex:[indexPath row]] displayName];
    // Configure the cell...
...
- (IBAction)addListener:(id)sender {
    [listenerIdField resignFirstResponder];
    WCListener *listener = [[WCListener alloc] init];
    listener.spotifyID = [listenerIdField text];
